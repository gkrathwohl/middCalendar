...
$xmlString = file_get_contents('http://25livepub.collegenet.com/calendars/featured-title-events-calendar-search.rss');
$xmlString1 = file_get_contents('http://25livepub.collegenet.com/calendars/all-campus-events.rss');
//
...
$time = date("G:i", strtotime($timeFormatted." ".$ampm[0]));
	   ...
	   // $room = htmlspecialchars("202");
	    ...
	    $genre = htmlspecialchars("featured");
